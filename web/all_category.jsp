  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <ul class="navbar-nav mr-right">
          <li class="nav-item">
              <a class="nav-link" href="profile.jsp">  <span class="fa fa-user"><%=s.getName()%></a>
          <li class="nav-item">
          ...
          <div  style=" border: 2px solid red;width:75%;height:auto;margin-left:400px;background-image:url(img/bg.jpg);background-size:cover; background-attachment: fixed ;"">
        
              <%
post_dao p1=new post_dao(Connection_provider.getConnection());
 List <post> l=p1.getALLPost();
 for(post p2:l)
 {
     %>
              <!-- Cards-->
        <div class="container">
            <div  class="row mb-6"> 
                <div class="card" style="margin-bottom: 30px; width: 18rem;">
